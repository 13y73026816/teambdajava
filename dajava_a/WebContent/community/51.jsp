...
<input type="password" name="Npassword" style="margin-left:500px;" value=""  placeholder="비밀번호를 입력해주세요">
<button style="width:100pt; height:25pt; margin-left:500px; margin-top:10px; "  id="save" type="button">등록</button>
